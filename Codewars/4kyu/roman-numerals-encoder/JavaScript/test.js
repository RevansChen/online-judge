...
Test.expect(solution(182) == "CLXXXII", "182 should == 'CLXXXII'")
Test.expect(solution(1990) == "MCMXC", "1990 should == 'MCMXC'")
Test.expect(solution(1875) == "MDCCCLXXV", "1875 should == 'MDCCCLXXV'")
Test.expect(solution(2008) == "MMVIII", "2008 should == 'MMVIII'")
Test.expect(solution(1666) == "MDCLXVI", "1666 should == 'MDCLXVI'")
